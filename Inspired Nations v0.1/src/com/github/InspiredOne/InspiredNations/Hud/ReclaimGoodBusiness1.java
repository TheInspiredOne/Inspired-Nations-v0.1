...
public class ReclaimGoodBusiness1 extends StringPrompt {
	...
	// Constructor
	public ReclaimGoodBusiness1(InspiredNations instance, Player playertemp, int errortemp, GoodBusiness busin) {
		plugin = instance;
		player = playertemp;
	...
	public String getPromptText(ConversationContext arg0) {
		...
		String main = ChatColor.BOLD + "Reclaim Business: Pick your selection type." + ChatColor.RESET + repeat(" ", 5)+ ChatColor.DARK_AQUA + repeat("-", 53) + ChatColor.YELLOW;
		String options = "";
	...
	public Prompt acceptInput(ConversationContext arg0, String arg) {
		...
		if (!input.contains(arg.toLowerCase())) return new ReclaimGoodBusiness1(plugin, player, 1, business);
		PM.clear();
		// Cuboid
		...
		return new ReclaimGoodBusiness2(plugin,player,0, business);
	}
