...
public class ReclaimServiceBusiness1 extends StringPrompt {
	...
	// Constructor
	public ReclaimServiceBusiness1(InspiredNations instance, Player playertemp, int errortemp, ServiceBusiness busin) {
		plugin = instance;
		player = playertemp;
	...
	public Prompt acceptInput(ConversationContext arg0, String arg) {
		...
		if (!input.contains(arg.toLowerCase())) return new ReclaimServiceBusiness1(plugin, player, 1, business);
		PM.clear();
		// Cuboid
		...
		return new ReclaimServiceBusiness2(plugin,player,0, business);
	}
