...
public class ClaimPark1 extends StringPrompt{
	...
	// Constructor
	public ClaimPark1(InspiredNations instance, Player playertemp, int errortemp) {
		plugin = instance;
		player = playertemp;
	...
	public Prompt acceptInput(ConversationContext arg0, String arg) {
		...
		if (!input.contains(arg.toLowerCase())) return new ClaimPark1(plugin, player, 1);
		PM.clear();
		// Cuboid
