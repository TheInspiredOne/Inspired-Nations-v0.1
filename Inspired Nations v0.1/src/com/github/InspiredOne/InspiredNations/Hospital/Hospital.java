...
public class Hospital {
	...
	public Hospital(InspiredNations instance, Cuboid space, String countrytemp, int towntemp) {
		plugin = instance;
		cubespace = space;
		country = countrytemp;
		town = towntemp;
	...
	public Hospital(InspiredNations instance, polygonPrism space, String countrytemp, int towntemp) {
		plugin = instance;
		polyspace = space;
		country = countrytemp;
		town = towntemp;
