...
public class ClaimLocalHallPlayerListener {
	...
	public ClaimLocalHallPlayerListener(InspiredNations instance, PlayerMoveEvent event) {
		plugin = instance;
	...
	public ClaimLocalHallPlayerListener(InspiredNations instance, PlayerInteractEvent event) {
		plugin = instance;
		player = event.getPlayer();
		playername = player.getName().toLowerCase();
		PDI = plugin.playerdata.get(playername);
	...
	public void onPlayerMove() {
		if (!PM.localHallSelect() || !(PM.isSelectingCuboid() || PM.isSelectingPolygon())) return;
