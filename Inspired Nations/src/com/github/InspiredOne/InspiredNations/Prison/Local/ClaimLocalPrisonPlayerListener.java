...
public class ClaimLocalPrisonPlayerListener {
	...
	public ClaimLocalPrisonPlayerListener(InspiredNations instance, PlayerMoveEvent event) {
		plugin = instance;
	...
	public ClaimLocalPrisonPlayerListener(InspiredNations instance, PlayerInteractEvent event) {
		plugin = instance;
		player = event.getPlayer();
		playername = player.getName().toLowerCase();
		PDI = plugin.playerdata.get(playername);
	...
	public void onPlayerMove() {
		if (!PM.localPrisonSelect() || !(PM.isSelectingCuboid() || PM.isSelectingPolygon())) return;
