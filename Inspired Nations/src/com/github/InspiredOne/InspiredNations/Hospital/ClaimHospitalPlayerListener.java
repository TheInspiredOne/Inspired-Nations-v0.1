 ...
 ******************************************************************************/
package com.github.InspiredOne.InspiredNations.Hospital;
...
public class ClaimHospitalPlayerListener {
	...
	public ClaimHospitalPlayerListener(InspiredNations instance, PlayerMoveEvent event) {
		plugin = instance;
	...
	public ClaimHospitalPlayerListener(InspiredNations instance, PlayerInteractEvent event) {
		plugin = instance;
		player = event.getPlayer();
		playername = player.getName().toLowerCase();
		PDI = plugin.playerdata.get(playername);
	...
	public void onPlayerMove() {
		if (!PM.hospitalSelect() || !(PM.isSelectingCuboid() || PM.isSelectingPolygon())) return;
