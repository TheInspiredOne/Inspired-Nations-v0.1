...
public class ClaimHousePlayerListener {
	...
	public ClaimHousePlayerListener(InspiredNations instance, PlayerMoveEvent event) {
		plugin = instance;
	...
	public ClaimHousePlayerListener(InspiredNations instance, PlayerInteractEvent event) {
		plugin = instance;
		player = event.getPlayer();
		playername = player.getName().toLowerCase();
		PDI = plugin.playerdata.get(playername);
	...
	public String generateMessage() {
		...
		String main ="";
		if (PM.reSelectHouse) {
			main = ChatColor.BOLD + "Reclaim House: Type what you would like to do." + ChatColor.RESET + repeat(" ", 5)+ ChatColor.DARK_AQUA + repeat("-", 53) + ChatColor.YELLOW;

		}
		else {
			main = ChatColor.BOLD + "New House: Type what you would like to do." + ChatColor.RESET + repeat(" ", 5)+ ChatColor.DARK_AQUA + repeat("-", 53) + ChatColor.YELLOW;
		}
		String options = "";
