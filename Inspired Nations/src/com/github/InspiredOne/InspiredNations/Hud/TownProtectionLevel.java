...
public class TownProtectionLevel extends StringPrompt {
	...
	public String getPromptText(ConversationContext arg0) {
		...
		options = options.concat(ChatColor.GOLD + "Level 0: " + ChatColor.YELLOW + "(No protection) Anybody can build in your town. Town Land can be" +
				" claimed by other towns." + repeat(" ", 30));
		options = options.concat(ChatColor.GOLD + "Level 1: " + ChatColor.YELLOW + "(Claim Protection) Town land cannot be claimed by other towns." + repeat(" ", 60));
		...
		options = options.concat(ChatColor.GOLD + "Level 3: " + ChatColor.YELLOW + "(Block and Interactable Protection) Only town residents can build and interact in your town." + repeat(" ", 20));
		options = options.concat(ChatColor.GOLD + "Level 4: " + ChatColor.YELLOW + "(Player Protection) Players are protected from attacks while within the town boundary." + repeat(" ", 5));
		options = options.concat(ChatColor.DARK_AQUA + repeat("-", 53) + ChatColor.GREEN);
